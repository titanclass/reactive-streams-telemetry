    ...
    test("writeTracing") {
      ...
      reporter.source
        ...
        .map { s =>
          val json = s.toJson
          val re =
            """\{"baggage":\[],"duration":.*,"logs":\[\{"time":0,"fields":\{},"message":"hello-world"},\{"time":0,"fields":\{"f0":"0","f1":"1"}}],"operationName":"some-span","references":\[],"spanId":.*,"start":.*,"tags":\{"sampler.type":"const","sampler.param":"true"},"traceId":.*}""".r
